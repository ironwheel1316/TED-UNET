...
# python test.py --model_dir models/<model_name> --dataset <dataset_name>
# python test.py --model_dir kvasir_seg_288_Conv3UNet_woDS_20250531_073505 --dataset kvasir_seg_288 --arch Conv3UNet
# python test.py --model_dir clinicdb_96_UNet_woDS_20250604_134331 --dataset clinicdb_96 --arch UNet

# python test.py --model_dir dsb2018_96_UNet_woDS_20250527_175114 --dataset dsb2018_96 --arch UNet
# python test.py --model_dir clinicdb_96_ConvUNet3333_woDS_20250606_030435 --dataset clinicdb_96 --arch ConvUNet3333

# python test.py --model_dir dsb2018_96_ConvUNet321_woDS_20250528_050534 --dataset dsb2018_96 --arch ConvUNet321
# python test.py --model_dir kvasir_seg_96_ConvUNet11223_woDS_20250606_032324 --dataset kvasir_seg_96 --arch ConvUNet11223
# python test.py --model_dir kvasir_seg_96_UNet_woDS_20250528_031850 --dataset kvasir_seg_96 --arch UNet
# python test.py --model_dir kvasir_seg_96_NOR1UNet444_woDS_20250603_021929 --dataset kvasir_seg_96 --arch NOR1UNet444
    ...
    with torch.no_grad():
        ...
        for input, target, meta in test_loader:
            ...
            for i in range(input.size(0)):
                ...
                # 保存推理结果图片
                output_img = output_to_save[i].sigmoid().cpu().numpy().squeeze()
